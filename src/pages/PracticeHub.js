...
const LESSONS = [
  {
    ...
    pre:  { code: 'L1-PRE', title: 'Learn the Alphabet — American English', skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 11 },
    post: { code: 'L1-POST', title: 'Spell It Out! 🔤', skill: 'speaking', icon: '🎙️', type: 'AI Speaking', activityIndex: 12 },
  },
  {
  ...
  // ── B1 ──────────────────────────────────────────────────────────────────
  { num: 32, code: 'L32', title: 'The Elevator Incident',          level: 'B1',
    pre:  { code: 'L32-PRE',  title: 'The Elevator Incident — Listening',  skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 200 },
    post: { code: 'L32-POST', title: 'Arguments & Reactions — Reading',    skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 201 },
  },
  { num: 33, code: 'L33', title: 'Best Thing I Never Had',         level: 'B1',
    pre:  { code: 'L33-PRE',  title: 'Best Thing I Never Had — Listening', skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 202 },
    post: { code: 'L33-POST', title: 'Superlatives — Grammar Focus',       skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 203 },
  },
  { num: 34, code: 'L34', title: 'My Milkshake Is Better Than Yours!', level: 'B1',
    pre:  { code: 'L34-PRE',  title: 'Comparatives — Listening',           skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 204 },
    post: { code: 'L34-POST', title: 'Comparatives vs Superlatives',       skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 205 },
  },
  { num: 35, code: 'L35', title: 'What Will You Do Tonight?',      level: 'B1',
    pre:  { code: 'L35-PRE',  title: 'Future Plans — Listening',           skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 206, isVimeo: true },
    post: { code: 'L35-POST', title: 'Will vs Going To — Grammar',         skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 207 },
  },
  { num: 36, code: 'L36', title: 'Before Leaving the House',       level: 'B1',
    pre:  { code: 'L36-PRE',  title: 'Before Leaving — Listening',         skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 208 },
    post: { code: 'L36-POST', title: 'Imperatives & Reminders — Reading',  skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 209 },
  },
  { num: 37, code: 'L37', title: 'First Conditional',              level: 'B1',
    pre:  { code: 'L37-PRE',  title: 'First Conditional — Listening',      skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 210, isVimeo: true },
    post: { code: 'L37-POST', title: 'First Conditional — Grammar',        skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 211 },
  },
  { num: 38, code: 'L38', title: 'Second Conditional',             level: 'B1',
    pre:  { code: 'L38-PRE',  title: 'Second Conditional — Listening',     skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 212 },
    post: { code: 'L38-POST', title: 'Second Conditional — Grammar',       skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 213 },
  },
  { num: 39, code: 'L39', title: 'What If?',                       level: 'B1',
    pre:  { code: 'L39-PRE',  title: 'What If? — Listening',               skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 214 },
    post: { code: 'L39-POST', title: 'Hypothetical Situations — Reading',  skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 215 },
  },
  { num: 40, code: 'L40', title: 'Opinions',                       level: 'B1',
    pre:  { code: 'L40-PRE',  title: 'Giving Opinions — Listening',        skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 216 },
    post: { code: 'L40-POST', title: 'Opinion Language — Reading',         skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 217 },
  },
  { num: 41, code: 'L41', title: 'Brazilian Culture',              level: 'B1',
    pre:  { code: 'L41-PRE',  title: 'Brazilian Culture — Listening',      skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 218 },
    post: { code: 'L41-POST', title: 'Brazilian Culture — Reading',        skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 219 },
  },
  { num: 42, code: 'L42', title: 'Phrasal Verbs 1',                level: 'B1',
    pre:  { code: 'L42-PRE',  title: 'Phrasal Verbs — Listening',          skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 220 },
    post: { code: 'L42-POST', title: 'Phrasal Verbs GET — Reading',        skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 221 },
  },
  { num: 43, code: 'L43', title: 'Storytelling',                   level: 'B1',
    pre:  { code: 'L43-PRE',  title: 'Storytelling — Listening',           skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 222 },
    post: { code: 'L43-POST', title: 'Storytelling Techniques — Reading',  skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 223 },
  },
  { num: 44, code: 'L44', title: 'The Participle',                 level: 'B1',
    pre:  { code: 'L44-PRE',  title: 'The Participle — Listening',         skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 224, isVimeo: true },
    post: { code: 'L44-POST', title: 'Past Participle — Grammar',          skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 225 },
  },
  { num: 45, code: 'L45', title: 'Have You Ever...?',              level: 'B1',
    pre:  { code: 'L45-PRE',  title: 'Present Perfect — Listening',        skill: 'listening', icon: '🎧', type: 'Video + Questions', activityIndex: 226, isVimeo: true },
    post: { code: 'L45-POST', title: 'Present Perfect — Grammar',          skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 227 },
  },
  { num: 46, code: 'L46', title: 'Already / Yet',                  level: 'B1',
    pre:  { code: 'L46-PRE',  title: 'Already / Yet — Writing',            skill: 'writing',   icon: '✏️', type: 'Open Writing',     activityIndex: 228 },
    post: { code: 'L46-POST', title: 'Already / Yet — Reading',            skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 229 },
  },
  { num: 47, code: 'L47', title: 'Final Review B1',                level: 'B1',
    pre:  { code: 'L47-PRE',  title: 'B1 Final Review — 5 Questions',      skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 230 },
    post: { code: 'L47-POST', title: 'B1 Final Review — 5 Questions',      skill: 'reading',   icon: '📖', type: 'Multiple Choice',  activityIndex: 231 },
  },
];
